    ...
    <div class="banner" style="background-image:url(<?php echo base_url() ?>assets/img/banner-9.jpg);">
        <div class="container">
        ...
        <div class="company-brand">
            <div class="container">
                <div id="company-brands" class="owl-carousel">
                    <div class="brand-img"><img src="<?php echo base_url() ?>assets/img/microsoft-home.png" class="img-responsive" alt=""/>
                    </div>
                    <div class="brand-img"><img src="<?php echo base_url() ?>assets/img/img-home.png" class="img-responsive" alt=""/></div>
                    <div class="brand-img"><img src="<?php echo base_url() ?>assets/img/mothercare-home.png" class="img-responsive" alt=""/>
                    </div>
                    <div class="brand-img"><img src="<?php echo base_url() ?>assets/img/paypal-home.png" class="img-responsive" alt=""/></div>
                    <div class="brand-img"><img src="<?php echo base_url() ?>assets/img/serv-home.png" class="img-responsive" alt=""/></div>
                    <div class="brand-img"><img src="<?php echo base_url() ?>assets/img/xerox-home.png" class="img-responsive" alt=""/></div>
                    <div class="brand-img"><img src="<?php echo base_url() ?>assets/img/yahoo-home.png" class="img-responsive" alt=""/></div>
                    <div class="brand-img"><img src="<?php echo base_url() ?>assets/img/mothercare-home.png" class="img-responsive" alt=""/>
                    </div>
                </div>
            </div>
            ...
            <div class="row extra-mrg">
                <div class="col-md-3 col-sm-6">
                    <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="<?php echo base_url() ?>assets/img/com-1.jpg" class="img-responsive"
                                                                alt=""/></div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="<?php echo base_url() ?>assets/img/com-2.jpg" class="img-responsive"
                                                                alt=""/></div>
                        <div class="brows-job-position">
                            <h3><a href="job-detail.html">Web Developer</a></h3>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="<?php echo base_url() ?>assets/img/com-3.jpg" class="img-responsive"
                                                                alt=""/></div>
                        <div class="brows-job-position">
                            <h3><a href="job-detail.html">Web Developer</a></h3>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="<?php echo base_url() ?>assets/img/com-4.jpg" class="img-responsive"
                                                                alt=""/></div>
                        <div class="brows-job-position">
                            <h3><a href="job-detail.html">Web Developer</a></h3>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="<?php echo base_url() ?>assets/img/com-5.jpg" class="img-responsive"
                                                                alt=""/></div>
                        <div class="brows-job-position">
                            <h3><a href="job-detail.html">Web Developer</a></h3>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="<?php echo base_url() ?>assets/img/com-6.jpg" class="img-responsive"
                                                                alt=""/></div>
                        <div class="brows-job-position">
                            <h3><a href="job-detail.html">Web Developer</a></h3>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="<?php echo base_url() ?>assets/img/com-7.jpg" class="img-responsive"
                                                                alt=""/></div>
                        <div class="brows-job-position">
                            <h3><a href="job-detail.html">Web Developer</a></h3>
    ...
    <div class="clearfix"></div>
    <section class="video-sec dark" id="video" style="background-image:url(<?php echo base_url() ?>assets/img/banner-10.jpg);">
        <div class="container">
            <div class="row">
                <div class="main-heading">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="working-process">
                        <span class="process-img"><img src="<?php echo base_url() ?>assets/img/step-1.png" class="img-responsive" alt=""/><span
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="working-process">
                        <span class="process-img"><img src="<?php echo base_url() ?>assets/img/step-2.png" class="img-responsive" alt=""/><span
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="working-process">
                        <span class="process-img"><img src="<?php echo base_url() ?>assets/img/step-3.png" class="img-responsive" alt=""/><span
        ...
        <div class="container">
            ...
            <div class="row">
                <div id="client-testimonial-slider" class="owl-carousel">
                    ...
                    <div class="client-testimonial">
                        <div class="pic"><img src="<?php echo base_url() ?>assets/img/client-3.jpg" alt=""></div>
                        <p class="client-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                            eiusmod tempor et dolore magna aliqua.</p>
                    ...
                    <div class="freelance-container style-2">
                        <div class="freelance-box">
                            ...
                            <div class="freelance-inner-box">
                                <div class="freelance-box-thumb"><img src="<?php echo base_url() ?>assets/img/can-5.jpg"
    ...
    <section class="download-app" style="background-image:url(<?php echo base_url() ?>assets/img/banner-7.jpg);">
        <div class="container">
            <div class="col-md-5 col-sm-5 hidden-xs"><img src="<?php echo base_url() ?>assets/img/iphone.png" alt="iphone"
